...
public final class UrlResponse {
    ...
    protected final CookiePack cookies = new CookiePack();
    ...
    @Override public String toString() {
        return httpBase.getClass().getSimpleName() + " " + httpBase.reqHttpMethod.name() + " url: " + uriPath + Optional.ofNullable(postText).map(v -> ", postText: " + postText).orElse("");
    }
}
