...
@Slf4j
@Getter
public final class ExecutorVirtualServices2 implements Executor, IExecutorServices {
     ...
     * @return
     */
    protected ExecutorVirtualServices2(String name, int coreSize, int maxSize) {
    ...
    @Override public ExecutorVirtualServices2 setQueueCheckSize(long queueCheckSize) {
