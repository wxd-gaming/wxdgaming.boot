...
import org.wxd.boot.net.http.client.jdk.HttpBuilder;
...
public class IBackendApiImplTest {
    ...
    @Test
    public void testAsyncBackRegister() throws InterruptedException {
        ...
        HttpBuilder
                ...
                .header(HttpHeadNameType.Content_Type, HttpHeadValueType.Multipart)
                .putParams(params)
                .async(r -> {
                    String s = r.bodyUnicodeDecodeString();
                    log.info("{} {}：{}", "dd", "接口测试", FastJsonUtil.toJson(s));
                });
        Thread.sleep(5000);
    }
